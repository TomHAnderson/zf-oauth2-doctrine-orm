...
use ZF\OAuth2\Doctrine\Document;
use ZFTest\OAuth2\Doctrine\Document\User;
...
abstract class BaseTest extends \Zend\Test\PHPUnit\Controller\AbstractHttpControllerTestCase
{
    ...
    protected function setUp()
    {
        $this->setApplicationConfig(
            include __DIR__ . '/../asset/odm.config.php'
        );
        ...
        try {
            $objectManager->getRepository('ZF\OAuth2\Doctrine\Document\Scope')->findAll();
        } catch (Exception $e) {
            $bcrypt = new Bcrypt();
            $bcrypt->setCost(14);
...
#            $res = $tool->createSchema($objectManager->getMetadataFactory()->getAllMetadata());
            ...
            $accessToken = new Document\AccessToken();
            ...
            $authorizationCode = new Document\AuthorizationCode();
            ...
            $refreshToken = new Document\RefreshToken();
...
");
            ...
            $publicKey = new Document\PublicKey();
